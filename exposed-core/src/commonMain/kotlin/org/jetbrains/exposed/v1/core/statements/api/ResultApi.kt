...
interface RowApi {
     ...
     */
    fun <T : Any> getObject(index: Int, type: KClass<T>): T?
     ...
     * @return The object converted to the specified type
     */
    fun <T : Any> getObject(name: String, type: KClass<T>): T?
    ...
    fun <T : Any> getObject(index: Int, type: KClass<T>?, columnType: IColumnType<*>): T? = type?.let { getObject(index, it) }
     ...
     * @return The object converted to the specified type
     */
    fun <T : Any> getObject(name: String, type: KClass<T>, columnType: IColumnType<*>): T? = getObject(name, type)
